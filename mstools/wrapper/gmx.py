...
class GMX:
    ...
    def grompp(self, mdp='grompp.mdp', gro='conf.gro', top='topol.top', tpr_out='md.tpr',
        ...
        get_cmd : bool
            If set to True, the command for running `gmx grompp` will be returned, which can be feed into :class:`~mstools.jobmanager.JobManager`.
    ...
    def density(self, trj, tpr, xvg='density.xvg', group='System', begin=0, end=None,
        ...
        get_cmd : bool
            If set to True, the command for running `gmx density` will be returned, which can be feed into :class:`~mstools.jobmanager.JobManager`.
