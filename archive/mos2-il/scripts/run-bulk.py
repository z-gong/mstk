...
parser.add_argument('-t', '--temp', type=float, default=300, help='temperature in Kelvin')
...
def run_simulation(gro_file='conf.gro', psf_file='topol.psf', prm_file='ff.prm',
...
if __name__ == '__main__':
    oh.print_omm_info()
    sim = run_simulation(gro_file=args.gro, psf_file=args.psf, prm_file=args.prm,
